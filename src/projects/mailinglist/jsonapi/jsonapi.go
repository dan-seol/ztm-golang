...
func Serve(db *sql.DB, bind string) {
	...
	err := http.ListenAndServe(bind, nil) // nil uses default handler
	if err != nil {
		log.Fatalf("JSON server error: %v", err) //Fatalf terminates the app completely
	}
}
